...
// $livre2 = new Livre(2, "Apprendre le Java", "apprendre-java.png", 700);
// $livre3 = new Livre(3, "Apprendre Docker", "apprendre-docker.png", 400);
// $livre4 = new Livre(4, "Apprendre le PHP", "apprendre-php.png", 300);
// $livre5 = new Livre(4, "Apprendre le Javascript", "apprendre-js.png", 300);
...
<table class="table table-center">
    ...
    foreach ($livresEnCours as $livre) : ?>
        <tr>
            <td class="align-middle"><img src="public/images/<?= $livre->getImage(); ?>" height="60px" alt="<?= "Livre : " .  $livre->getTitre(); ?>"></td>
